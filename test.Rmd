...
#asset_return_matrix     <- round(asset_return_matrix, 2)
client_value_matrix     <- matrix(initial_client_capital, nrow = n_simulations, ncol = (n_periods))
...
for (i in 2:(n_periods + 1)){
    ...
    client_value_matrix[, i-1]    <- client_value_matrix[, i-1] * (1 + asset_return_matrix[, i-1])
}

client_value_matrix[, i]    <- (client_value_matrix[, i-1] * (1 + asset_return_matrix[, i-1]))
...
plot_sim(
  ...
  hedge_fund_performance_fee = 0.1, 
...
matrix(NA, nrow = 10000, ncol = 50)
matrix(initial_client_capital, nrow = n_simulations, ncol = (50 + 1))
hedge_fund_management_fee = 0.02
  hedge_fund_performance_fee = 0.1 
  hedge_fund_watermark = 0.00 
  sample_mean_return = 0.1 
